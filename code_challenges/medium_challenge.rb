...
# Write a program that evaluates the status of the variables above, and uses logic to 
#print one of three possible messages:
...
if good_driving_record == true && age > 25
    p "You will get a discount on your car rental"
